...
public class SelectDomoItem extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        aryActuators = toDoDBAdapter.getAllActuators(ConfDatabase.ACTUATOR_TYPE + "!=" + "? AND " + ConfDatabase.ACTUATOR_TYPE + "!=" + "? AND " + ConfDatabase.ACTUATOR_TYPE + "!=" + "? AND " + ConfDatabase.ACTUATOR_TYPE + "!=" + "?", 
        		new String[]{ConfDatabase.TYPE_TEMPERATURE, ConfDatabase.TYPE_WATTMETER, ConfDatabase.TYPE_ACTION, ConfDatabase.TYPE_HUMIDITY}, 
        		null);        
